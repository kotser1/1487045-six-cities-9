...
import { loadOffers, loadOffer, loadNearOffers, loadReviews, sendReview } from './offers-data/offers-data';
import { requireAuthorization, setUserEmail } from './user-data/user-data';
